...
WebUI.click(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/1Click a_Rejected'))

WebUI.setText(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/2ST Start Date'), '01/01/2023')

WebUI.setText(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/3ST End Date'), '12/12/2023')

WebUI.click(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/4CLick button_Search'))

WebUI.setText(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/5ST Comment'), 'AutoComment01')

WebUI.click(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/6Click Kirim'))

WebUI.delay(1)

WebUI.setText(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/7ST Search Nama Toko'), 'ridwan')
...
WebUI.setText(findTestObject('1.Action/Redeem/Produk Fisik/Rejected/Page_Bhakti Web/7ST Search Nama Toko'), '')
