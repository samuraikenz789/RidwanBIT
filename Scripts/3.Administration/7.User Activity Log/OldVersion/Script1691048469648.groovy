...
WebUI.click(findTestObject('7.User Activity Log/Page_Bhakti Web/25 Click Filter By Campaign'))

WebUI.click(findTestObject('7.User Activity Log/Page_Bhakti Web/26 Click Filter By Redeem'))

WebUI.click(findTestObject('7.User Activity Log/Page_Bhakti Web/27 Click Filter By Update Data'))
...
'kalau error, ganti dari 7.User Activity Log Backup apply button'
