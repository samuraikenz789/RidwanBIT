...
WebUI.doubleClick(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/input_Email address_email'))

WebUI.setText(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/input_Email address_email'), 
    'amink@jasakom.com')

WebUI.setEncryptedText(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/input_Password_password'), 
    'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.sendKeys(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/input_Password_password'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/a_Administration'))

WebUI.click(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/a_User Wallet Management'))

WebUI.click(findTestObject('Object Repository/3.Administration/6.User Wallet Management/User Wallet Management Suspend Wallet/Page_Bhakti Web/button_Cek Wallet'))
