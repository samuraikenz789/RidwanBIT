...
WebUI.click(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/1Click ComboBox Tipe'))

WebUI.delay(1)

WebUI.click(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/2Click Pilihan Whatsapp'))

WebUI.click(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/3Click Allow Broadcast'))

WebUI.click(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/4Click Public'))

WebUI.setText(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/5ST Judul Artikel'), 
    'WhatsAppJudulArtikel')

WebUI.setText(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/6ST Content'), 
    'WhatsAppContent')

WebUI.click(findTestObject('2.Master/BC Massage Tamplate/BC Massage Tamplate Tipe Whatsapp/Page_Bhakti Web/7Click Submit'))

WebUI.delay(1)

'Take Photo ada di C:\\Users\\Admin\\Katalon Studio\\New-Mishirin-Website dengan nama sesuai yang di input'
WebUI.takeScreenshot('TamplateWhatsapp.PNG')
