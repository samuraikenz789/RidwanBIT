...
WebUI.click(findTestObject('2.Master/Master Target Peserta/User Group/User Tags MD/Page_Bhakti Web/20Click Checkbox Toko Rino'))

WebUI.click(findTestObject('2.Master/Master Target Peserta/User Group/User Tags MD/Page_Bhakti Web/21Click button_Update JAKARTATEST2'))

WebUI.delay(1)

WebUI.click(findTestObject('2.Master/Master Target Peserta/User Group/User Tags MD/Page_Bhakti Web/22Click button_Yes'))
