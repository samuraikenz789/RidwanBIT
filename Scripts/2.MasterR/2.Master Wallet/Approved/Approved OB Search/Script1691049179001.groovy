...
WebUI.click(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/3Clicka_Approved'))

'A-Z'
WebUI.click(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/4ST OB th_Nama Wallet'))
...
'A-Z'
WebUI.click(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/5ST OB th_Tipe Wallet'))
...
'A-Z'
WebUI.click(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/6ST OB th_Balance'))

'Take Photo ada di C:\\Users\\Admin\\Katalon Studio\\New-Mishirin-Website dengan nama sesuai yang di input'
WebUI.takeScreenshot('BalanceOB1-100.PNG')
...
'Take Photo ada di C:\\Users\\Admin\\Katalon Studio\\New-Mishirin-Website dengan nama sesuai yang di input'
WebUI.takeScreenshot('BalanceOB100-1.PNG')

'Delay\r\n'
WebUI.delay(2)

'A-Z'
WebUI.click(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/7ST OB th_Campaign Terhubung'))
...
'A-Z'
WebUI.click(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/8ST OB th_Status'))

'Take Photo ada di C:\\Users\\Admin\\Katalon Studio\\New-Mishirin-Website dengan nama sesuai yang di input'
WebUI.takeScreenshot('StatusOBA-Z.PNG')
...
'Take Photo ada di C:\\Users\\Admin\\Katalon Studio\\New-Mishirin-Website dengan nama sesuai yang di input'
WebUI.takeScreenshot('StatusOBZ-A.PNG')

'Delay\r\n'
WebUI.delay(2)

WebUI.setText(findTestObject('2.Master/Master Wallet/Approved OB Search/Page_Bhakti Web/9ST Search Nama Wallet'), 'UNDIAN AKHIR TAHUN MISHIRIN')
